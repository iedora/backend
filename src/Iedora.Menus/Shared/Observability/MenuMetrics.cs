...
/// </summary>
internal static class MenuMetrics
{
    private static readonly Meter Meter = new("Iedora.Menus");
    ...
    public static readonly Counter<long> Views =
        Meter.CreateCounter<long>("menu.views", unit: "{view}", description: "Public menu view beacons served.");
    ...
    public static readonly Counter<long> ItemViews =
        Meter.CreateCounter<long>("menu.item_views", unit: "{view}", description: "Dish views reported by guests.");
    ...
    public static readonly Histogram<int> Dwell =
        Meter.CreateHistogram<int>("menu.session.dwell", unit: "s", description: "Guest session dwell time.");
    ...
    public static readonly Counter<long> Errors =
        Meter.CreateCounter<long>("iedora.errors", description: "Handled errors recorded in the Menu module.");
}
